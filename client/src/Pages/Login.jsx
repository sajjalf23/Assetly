...
import GoogleIcon from "../assets/googleicon.png"; // You can replace with your SVG URL if needed

const Login = () => {
  const { setUserData, setIsLoggedIn ,UserData} = useContext(AppContext);
