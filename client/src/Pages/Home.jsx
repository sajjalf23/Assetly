    ...
    const sectors = useMemo(() => [
        {
            ...
            rawPercentage: ((stats?.balances?.crypto || 0) / total) * 100,
            percentage: formatPercentage(stats?.balances?.crypto || 0, total),
            color: "bg-[#8b5cf6]",
            icon: <LuCpu />
        },
        {
            ...
            rawPercentage: ((stats?.balances?.forex || 0) / total) * 100,
            percentage: formatPercentage(stats?.balances?.forex || 0, total),
            color: "bg-[#fbbf34]",
            icon: <LuGlobe />
        },
        {
            ...
            rawPercentage: ((stats?.balances?.stocks || 0) / total) * 100,
            percentage: formatPercentage(stats?.balances?.stocks || 0, total),
            color: "bg-[#3b82f6]",
            icon: <LuWallet />
        }
    ], [stats, total]);
            ...
            <div className="bg-[#0d0d0d] min-h-screen pt-10 text-white w-full overflow-x-hidden">
                <div className="p-6 max-w-7xl mx-auto flex flex-col gap-6">
                                    ...
                                    sectors.map((sector, i) => (
                                        <div key={i} className="space-y-1.5">
                                            ...
                                            <div className="w-full bg-[#202020] h-2 rounded-full overflow-hidden">
                                                <div className={`h-full ${sector.color}`} style={{ width: `${sector.rawPercentage}%` }} />
                                            </div>
                                        </div>
                                    ))
                                )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-2">
                        {/* API Status Card */}
                        <div className="bg-[#181818] p-5 rounded-xl border border-[#2a2a2a] flex items-center gap-4 hover:bg-[#1f1f1f] transition-colors">
