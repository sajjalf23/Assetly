                    ...
                    <div>
                        ...
                        <motion.div
                            ...
                            <div className="p-4 rounded-lg bg-white/5">
                                <div className="text-sm text-white/60">{displayMarketData.crypto.symbol}/USD</div>
                                <div className="text-lg font-semibold">${displayMarketData.crypto.price?.toLocaleString()}</div>
                                <div className={`text-sm ${displayMarketData.crypto.change > 0
                                    ? "text-[#00e238]"
                                    : displayMarketData.crypto.change < 0
                                        ? "text-[#ff0000]"
                                        : "text-white/60"}`}>{formatChange(displayMarketData.crypto.change)}</div>
                            </div>
                            <div className="p-4 rounded-lg bg-white/5">
                                <div className="text-sm text-white/60">{displayMarketData.stock.symbol}</div>
                                <div className="text-lg font-semibold">${displayMarketData.stock.price?.toFixed(2)}</div>
                                <div className={`text-sm ${displayMarketData.stock.change > 0
                                    ? "text-[#00e238]"
                                    : displayMarketData.stock.change < 0
                                        ? "text-[#ff0000]"
                                        : "text-white/60"}`}>{formatChange(displayMarketData.stock.change)}</div>
                            </div>
                            <div className="p-4 rounded-lg bg-white/5">
                                <div className="text-sm text-white/60">{displayMarketData.forex.symbol}</div>
                                <div className="text-lg font-semibold">${displayMarketData.forex.price?.toFixed(4)}</div>
                                <div className={`text-sm ${displayMarketData.forex.change > 0
                                    ? "text-[#00e238]"
                                    : displayMarketData.forex.change < 0
                                        ? "text-[#ff0000]"
                                        : "text-white/60"}`}>{formatChange(displayMarketData.forex.change)}</div>
                            </div>
                        </motion.div>
                    </div>
                </section>
